...
#define SOUND_TIMERSOUND10			"misc/dragonstore/10.wav"
#define SOUND_TIMERSOUND9			"misc/dragonstore/9.wav"
#define SOUND_TIMERSOUND8			"misc/dragonstore/8.wav"
#define SOUND_TIMERSOUND7			"misc/dragonstore/7.wav"
#define SOUND_TIMERSOUND6			"misc/dragonstore/6.wav"
#define SOUND_TIMERSOUND5			"misc/dragonstore/5.wav"
#define SOUND_TIMERSOUND4			"misc/dragonstore/4.wav"
#define SOUND_TIMERSOUND3			"misc/dragonstore/3.wav"
#define SOUND_TIMERSOUND2			"misc/dragonstore/2.wav"
#define SOUND_TIMERSOUND1			"misc/dragonstore/1.wav"
...
public void OnMapStart()
{
    ...
    PrecacheSound(SOUND_TIMERSOUND10);
    PrecacheSound(SOUND_TIMERSOUND9);
    PrecacheSound(SOUND_TIMERSOUND8);
    PrecacheSound(SOUND_TIMERSOUND7);
    PrecacheSound(SOUND_TIMERSOUND6);
    PrecacheSound(SOUND_TIMERSOUND5);
    PrecacheSound(SOUND_TIMERSOUND4);
    PrecacheSound(SOUND_TIMERSOUND3);
    PrecacheSound(SOUND_TIMERSOUND2);
    PrecacheSound(SOUND_TIMERSOUND1);
    ...
    if(g_iCountdownCount < g_fCountdownTime) {
        for(int iClient = 1; iClient < MaxClients; iClient++) {
            if(IsClientInGame(iClient)) {
                ...
                IntToString(iTimeDelta, szSound, 15);
                ClientCommand(iClient, "play misc/dragonstore/%s", szSound);
